    ...
    >
      <div className="mb-4 flex flex-wrap items-center gap-3">
        <div className="flex flex-wrap gap-2">
          <button type="button" className={tabBtn(layout === "s")} onClick={() => setLayout("s")}>
            Layout S
          </button>
        ...
        <Link
          to={layout === "s" ? "/portfolio/layout-s" : layout === "k" ? "/portfolio/layout-k" : "/portfolio/layout-t"}
      ...
      <div className="rounded-xl border border-slate-200 bg-slate-100 dark:border-slate-700 dark:bg-slate-900/50">
        <div className="max-h-[min(72vh,920px)] overflow-auto">
          ...
          >
            {layout === "s" ? <LayoutS /> : layout === "k" ? <LayoutK /> : <LayoutT />}
          </div>
        </div>
      </div>
    </Card>
